...
<body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand font-weight-bold text-white js-scroll-trigger" href="#page-top">ELECTRONICA</a>
        ...
        <header class="masthead">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    ...
                    <h2><p class="text-white-75 font-weight-bold mt-0">Tienda Electronica</p></h2>
                    </div>
                </div>
            </div>
        </header>
            ...
            <div class="container">
                <div class="row justify-content-center">                  
                    <div class="col-lg-8 text-center">
                      <img src="{{asset ('images/mandoP.jpg')}}" alt="" width="150">
                      <img src="{{asset ('images/mandoX.jpg')}}" alt="" width="150">
                      <img src="{{asset ('images/mezcla.jpg')}}" alt="" width="150">
                        ...
                        <table  class="table table-striped table-sm">
                            ...
                            <tr>
                                <td  ALIGN=CENTER >Control Inalámbrico DualShock 4 - PlayStation 4 Standard Edition</td>
                                <td  ALIGN=CENTER >$1,599.00</td>
                                <td  ALIGN=CENTER>
                                    <input id="p1" type="number" name="p1"min="0" max="250" value="0">
                                </td>
                            </tr>
                            <tr>
                                <td  ALIGN=CENTER >Microsoft 4N6-00001 Xbox Controller + Cable for Windows</td>
                                <td  ALIGN=CENTER >$1,629.00</td>
                                <td  ALIGN=CENTER>
                                    <input id="p2" type="number" name="p1"min="0" max="250" value="0">
                                </td>
                            </tr>
                            <tr>
                                <td  ALIGN=CENTER >Behringer XR18 Mezcladora, color Negro</td>
                                <td  ALIGN=CENTER >$14,999.00</td>
                                <td  ALIGN=CENTER>
                                    <input id="p3" type="number" name="p1"min="0" max="80" value="0">
                                </td>
                            </tr>
                        </table>
                        <button type="button" class="btn btn-success">
